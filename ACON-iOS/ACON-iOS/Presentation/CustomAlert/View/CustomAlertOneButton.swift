...
struct CustomLocationAlertViewPreview: UIViewControllerRepresentable {
    
    // `UIViewControllerRepresentable` 필수 메서드
    func makeUIViewController(context: Context) -> UIViewController {
        let viewController = CustomLocationAlertView()
...
// SwiftUI Preview를 위한 확장
struct CustomLocationAlertViewPreview_Previews: PreviewProvider {
    static var previews: some View {
        CustomLocationAlertViewPreview()
            .ignoresSafeArea() // Preview에서 안전 영역 무시
    }
}
