...
enum GlassmorphismType {
    ...
    var blurIntensity: CGFloat {
        switch self {
        case .buttonGlassDefault, .buttonGlassPressed, .buttonGlassSelected, .buttonGlassDisabled, .toastGlass, .gradientGlass:
            return 0.2
    ...
    var blurEffectStyle: UIBlurEffect.Style {
        switch self {
        case .buttonGlassDefault, .actionSheetGlass, .alertGlass:
